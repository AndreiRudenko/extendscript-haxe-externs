...
@:native("Scrollbar") extern class Scrollbar {
	...
	/* { b => value, text => The minimum value allowed in the  property. } */
	var minvalue:Float; 

	/* { b => value, text => The maximum value allowed in the  property. } */
	var maxvalue:Float; 

	/* True if this element is active. */
	var active:Bool; 

	/* { text => The key sequence that invokes the   callback for this element (in Windows only)., a => { text => onShortcutKey(), href => /Scrollbar/event/onShortcutKey } } */
	var shortcutKey:String; 

	/* { text => The graphics object that can be used to customize the element's appearance, in response to the  event., a => { text => onDraw(), href => /Scrollbar/event/onDraw } } */
	...
	/*
	 * { text => An event-handler callback function, called when the element's  sequence is typed in the active window., a => { text => shortcutKey, href => /Scrollbar/shortcutKey } }
	 */
